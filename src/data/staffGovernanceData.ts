...
export const nonHumanIdentities: NonHumanIdentity[] = [
  ...
  {
    userId: 'svc-security-scanner',
    firstName: 'Security Scanner',
    lastName: 'Agent',
    email: 'svc-security-scanner@noreply.internal',
    group: 'grp-security-ops',
    description: 'Scans infrastructure and AI assets for security findings. Holds no patient roles — its blast radius excludes all patient data entirely (read and write both denied).',
    iconKey: 'ShieldCheck',
    accentColor: '#7c5cff',
    iconBg: '#7c5cff',
    permissions: [
      { op: 'deny', target: 'u_patient (all)', description: 'No patient data access — read and write denied' },
    ],
    aclRules: [
      { label: 'patient deny', table: 'u_patient', level: 'deny' },
    ],
    roles: [],
  },
  {
    userId: 'svc-security-remediation',
    firstName: 'Security Remediation',
    lastName: 'Agent',
    email: 'svc-security-remediation@noreply.internal',
    group: 'grp-security-ops',
    description: 'Applies remediation actions to security findings. Holds no patient roles — cannot read or write any patient record.',
    iconKey: 'ShieldCheck',
    accentColor: '#7c5cff',
    iconBg: '#7c5cff',
    permissions: [
  ...
  {
    userId: 'svc-threat-intel',
    firstName: 'Threat Intel',
    lastName: 'Agent',
    email: 'svc-threat-intel@noreply.internal',
    group: 'grp-security-ops',
    description: 'Enriches findings with threat intelligence. Holds no patient roles — patient data is entirely out of scope.',
    iconKey: 'Activity',
    accentColor: '#7c5cff',
    iconBg: '#7c5cff',
    permissions: [
  ...
  {
    userId: 'svc-pipeline-orchestrator',
    firstName: 'Pipeline Orchestrator',
    lastName: 'Agent',
    email: 'svc-pipeline-orchestrator@noreply.internal',
    group: 'grp-security-ops',
    description: 'Orchestrates the security automation pipeline. Holds no patient roles — cannot touch any patient record.',
    iconKey: 'ClipboardList',
    accentColor: '#7c5cff',
    iconBg: '#7c5cff',
    permissions: [
