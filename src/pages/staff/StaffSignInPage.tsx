...
export function StaffSignInPage() {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="grid w-[540px] gap-4 rounded-xl border border-[#d7e5ec] bg-white p-6">
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0b1f2e]/45 px-4">
      <div className="w-full max-w-[420px] rounded-[14px] border border-[#d7e5ec] bg-white p-6 shadow-[0_18px_50px_rgba(12,37,54,0.22)]">
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-5 inline-flex min-h-[40px] items-center justify-center rounded-[9px] bg-[#0f5f8c] px-4 font-bold text-white"
        >
          Close
        </button>
      </div>
