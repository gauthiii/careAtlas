...
import { AlertTriangle, KeyRound, LoaderCircle, LockKeyhole, QrCode } from 'lucide-react'
...
export function GovernanceSignInPage() {
  ...
  useEffect(() => {
    if (isAuthenticated) navigate('/governance', { replace: true })
  ...
  return (
    <PortalPage
      ...
      title="Access AI Governance"
      intro={
        newPasswordSession
          ? 'Set a permanent governance account password before continuing to MFA.'
          : 'Use your governance account email and password, then complete authenticator MFA.'
      }
    >
          ...
          {setupData && (
            <section className="grid gap-4 rounded-[12px] border border-[#d7e5ec] bg-[#f7fbfd] p-4">
              ...
              <img
                ...
                alt="Governance authenticator app QR code"
